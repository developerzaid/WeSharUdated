...
public class GetLocation {
    ...
    private void getLastLocation() {
        ...
        if (checkPermissions()) {
            ...
            if (isLocationEnabled()) {
                ...
                Toast.makeText(mMain, "Please turn on" + " your location...", Toast.LENGTH_LONG).show();
    ...
    private void requestPermissions() {
        ActivityCompat.requestPermissions(mMain, new String[]{
    ...
    private boolean isLocationEnabled() {
        LocationManager locationManager = (LocationManager) mMain.getSystemService(Context.LOCATION_SERVICE);
